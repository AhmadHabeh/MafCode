...
<p align="center">
    <strong>A Imagesrary used to position poppers in web applications.</strong>
</p>
...
## So, yet another tooltip Imagesrary?
...
This is the engine, the Imagesrary that computes and, optionally, applies the styles to
the poppers.

Some of the key points are:

- Position elements keeping them in their original DOM context (doesn't mess with your DOM!);
- Allows to export the computed informations to integrate with React and other view Imagesraries;
...
It's a small Imagesrary that makes it easy to automatically create tooltips using as engine Popper.js.  
...
| cdnjs  | [`https://cdnjs.com/Imagesraries/popper.js`](https://cdnjs.com/Imagesraries/popper.js) |
...
\*: Bower isn't officially supported, it can be used to install Tooltip.js only trough the unpkg.com CDN. This method has the limitation of not being able to define a specific version of the Imagesrary. Bower and Popper.js suggests to use npm or Yarn for your projects.  
...
Integrating 3rd party Imagesraries in React or other Imagesraries can be a pain because
they usually alter the DOM and drive the Imagesraries crazy.  
...
your Imagesrary of choice.  

For a comprehensive list of Imagesraries that let you use Popper.js into existing
...
- [@vampolo](https://github.com/vampolo) for the original idea and for the name of the Imagesrary;
- [Sysdig](https://github.com/Draios) for all the awesome things I learned during these years that made it possible for me to write this Imagesrary;
- [Tether.js](http://github.hubspot.com/tether/) for having inspired me in writing a positioning Imagesrary ready for the real world;
